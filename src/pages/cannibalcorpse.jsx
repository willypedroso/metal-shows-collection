...
export default function CannibalCorpse() {
    const band = "Cannibal Corpse";
    ...
    const allShowsCollect = shows.map(show => (<Card key={show.url} titleShow={show.title} url={show.url}/>));
